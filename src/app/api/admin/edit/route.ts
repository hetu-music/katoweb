...
export const GET = withAuth(async (_request: NextRequest, _user: AuthenticatedUser) => {
  try {
...
export const PUT = withAuth(async (request: NextRequest, _user: AuthenticatedUser) => {
  try {
    const body = await request.json();
