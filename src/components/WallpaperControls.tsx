...
const WallpaperControls: React.FC<WallpaperControlsProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* 展开的控制面板 */}
      <div
        className={`absolute top-12 right-0 flex flex-row gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-3 shadow-lg transition-all duration-300 z-50 ${
          isExpanded
