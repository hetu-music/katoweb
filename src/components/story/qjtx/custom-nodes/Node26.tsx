      ...
      <div className={`node-wrapper-${event.id} absolute inset-0`}>
        ...
        <div className={`scrolly-intro-${event.id} absolute inset-0 flex flex-col items-center justify-center px-4 md:px-8`}>
            ...
            <div className="relative flex flex-col items-center w-full max-w-[90vw]">
                <h2 className={`title-text-${event.id} relative text-4xl md:text-[5rem] text-transparent bg-clip-text bg-linear-to-b from-red-50 to-red-600/80 tracking-[0.5em] md:tracking-[0.6em] pl-[0.5em] md:pl-[0.6em] font-light text-center drop-shadow-[0_0_40px_rgba(220,38,38,0.6)] break-words leading-tight`}>
                    {detail.title}
                </h2>
            </div>
            
            <div className={`quote-text-${event.id} mt-8 md:mt-10 text-red-200/70 text-xs md:text-[15px] tracking-[0.4em] md:tracking-[0.6em] font-light text-center w-full max-w-[85vw] md:max-w-xl leading-[2.2] md:leading-[2.5] pl-[0.4em] md:pl-[0.6em] whitespace-normal break-words max-h-[30vh] overflow-y-auto no-scrollbar`}>
                {detail.quote}
            </div>
        </div>
        ...
        <div className={`scrolly-body-container-${event.id} absolute inset-0 flex items-center justify-center opacity-0 px-4 md:px-8`}>
            <div className="relative z-10 w-full max-w-7xl flex flex-col md:flex-row gap-6 md:gap-8 items-stretch md:items-end h-[85vh] md:h-[75vh]">
                ...
                <div className={`monolith-${event.id} relative w-full md:w-[40%] bg-[#050000]/95 border border-red-900/30 rounded-t-2xl shadow-[0_-20px_80px_rgba(220,38,38,0.15)] p-6 md:p-10 flex flex-col justify-start overflow-y-auto no-scrollbar md:h-[100%]`}>
        ...
        <div className={`scrolly-closing-container-${event.id} absolute inset-0 flex flex-col items-center justify-center opacity-0 px-4 md:px-8`}>
            <div className={`closing-text-${event.id} text-red-200/90 text-sm md:text-lg tracking-[0.8em] md:tracking-[1em] pl-[0.8em] md:pl-[1em] font-light drop-shadow-[0_0_20px_rgba(220,38,38,0.6)] text-center w-full max-w-[90vw] leading-loose break-words whitespace-normal max-h-[60vh] overflow-y-auto no-scrollbar`}>
                {detail.closing}
            </div>
            <div className={`closing-line-${event.id} mt-8 w-24 md:w-32 h-[1px] bg-linear-to-r from-transparent via-red-500/50 to-transparent`} />
        </div>
